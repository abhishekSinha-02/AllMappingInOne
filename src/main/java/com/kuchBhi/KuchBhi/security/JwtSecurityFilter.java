package com.kuchBhi.KuchBhi.security;
...
public class JwtSecurityFilter extends OncePerRequestFilter {
    ...
    HospitalUserRepo userRepo;

    public JwtSecurityFilter(JwtSecurityTokenUtils jwtSecurityTokenUtils, HospitalUserRepo userRepo) {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (authHeader != null){
            ...
            if (username != null && SecurityContextHolder.getContext().getAuthentication() == null){
                HospitalUser user = userRepo.findByUsername(username);
